...
export default function InfoEmployer() {
    ...
    const handleNext = () => { navigate("./hiringfields")}
    ...
    <>
        ...
        <OptionsWrapper>
            <SubWrapper>이름<Enter text="이름을 입력해주세요" /></SubWrapper>
            <SubWrapper>전화번호
                <EnterWrapper>
                    <input readOnly placeholder="010-1234-5678"/>
                </EnterWrapper>
            </SubWrapper>
            <SubWrapper>이메일<Enter text="이메일을 입력해주세요" /></SubWrapper>
            <SubWrapper>대표자명<Enter text="대표자명을 입력해주세요" /></SubWrapper>
            <SubWrapper>기업명<Enter text="회사명을 입력해주세요" /></SubWrapper>
            <SubWrapper>주소입력
                <InputWrapper>
                ...
                <div className="alert" style={{fontSize:"15px" }}>아직은 서울특별시에서만 이용 가능해요.🥲</div>
            </SubWrapper>
            <SubWrapper>사업자 등록번호<Enter text="예)000-00-0000" /></SubWrapper>
            
        </OptionsWrapper>
        
    </ApplyWrapper> 
    <Footer><Button text="다음" type="White" onClick={handleNext} />
    </Footer>
    </>
    )
}
